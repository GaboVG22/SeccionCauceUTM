...
APP_VERSION = "v11_utm_datum_wgs84_19s"
...
def evaluate_modelable_sections(
    ...
    for sec in sections:
        ...
        if calidad_original == "DEBIL":
            reasons.append(f"control calidad: {motivo_original}" if motivo_original else "control calidad: sección débil")
